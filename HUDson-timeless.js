...
mw.loader.using('mediawiki.util').then(function() {
    ...
    function showScriptListAnim(scripts) {
        ...
        listDiv.style.right = '81em';
        listDiv.style.top = '45em';
        listDiv.style.zIndex = 'auto';
    ...
    var personalTools = document.querySelector('#site-tools .sidebar-inner .mw-portlet-body ul');
    if (personalTools) {
